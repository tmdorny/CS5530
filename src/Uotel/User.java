...
public class User {
	...
	public static String login(Statement statement, String user, String pass, Scanner scanner) {
	...
	public static void register(Statement statement, String user, Scanner scanner){
	...
	public static void addFavorite(Statement statement, String user, Scanner scanner) {
		...
		int hid = Integer.parseInt(TemporaryHome.getHid(statement, scanner.nextLine()));
